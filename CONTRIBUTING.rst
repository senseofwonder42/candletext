...
Welcome to ``candletext`` contributor's guide.
...
If you experience bugs or general issues with ``candletext``, please have a look
...
You can help improve ``candletext`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``candletext`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``candletext``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n candletext python=3 six virtualenv pytest pytest-cov
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/candletext.git
    cd candletext
...
#. Install |pre-commit|_::
   ...
   ``candletext`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/candletext
.. _issue tracker: https://github.com/<USERNAME>/candletext/issues
.. <-- end -->
